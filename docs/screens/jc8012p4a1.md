...
If the rear case marking is `2620` or higher, or the label on the back of your display has `V2` after the material number, use the [10.1-inch JC8012P4A1 V2](/screens/jc8012p4a1-v2) firmware instead. This page is for the original panel version.
:::

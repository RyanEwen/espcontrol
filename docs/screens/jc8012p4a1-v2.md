...
Use this firmware when the rear case marking is `2620` or higher, or when the label on the back of the display has `V2` after the material number. Original JC8012P4A1 boards with a lower rear case marking should use the standard [10.1-inch JC8012P4A1](/screens/jc8012p4a1) firmware instead.
:::

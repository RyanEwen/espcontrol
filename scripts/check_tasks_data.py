...
TASKS = (
    ...
    task("preview-features", ("node", "scripts/check_preview_features.js"), dependencies=("generated",), profiles=PRODUCT,
         domains=("product", "web"), inputs=("src/webserver/features/**", "tests/web/*_feature.test.ts", "tests/web/preview_grid.test.ts", "scripts/check_preview_features.js", "scripts/load_typescript_module.js"), parallel_safe=True),

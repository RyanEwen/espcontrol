...
export function createInitialState(deviceConfig: DeviceConfig): AppState {
  ...
  return {
    ...
    photosShowWeather: false, photosWeatherEntity: "", photosShowAgenda: false, photosAgendaEntities: "", photosAgendaStyle: "Next Event", photosAgendaOpacity: 45, photosAgendaLimit: 5,
